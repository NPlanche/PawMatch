...
.then(function (breeds) {
    ...
    topBreeds.forEach(function (item) {
        ...
        card.innerHTML = `
            ...
            <a id="reults-quiz-btn" href="/PawMatch/dog/dog-breed-detail.html">View Details</a>
        `;
        ...
        details.addEventListener("click", function (event) {
            ...
            window.location.href = "/PawMatch/dog/dog-breed-detail.html";
        });
...
if(retake){
    retake.addEventListener("click", function(){
        ...
        window.location.href = "/PawMatch/dog/dog-quiz.html";
    })
}
